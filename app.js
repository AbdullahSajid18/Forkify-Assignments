...
function singleItemDataInUi(data) {
    ...
    const product = `<div class="card mb-3" style="background-color: #f9f5f3; border: none;">
    <div class="img">
...
<div class="card ingredientCard mb-3" style="width: 100%; height: 400px; background-color: #f9f5f3; border: none;">
...
<div class="card mb-3" style="background-color: #f9f5f3; border: none;">
    <div class="card-body">
